...
@section('content-sub-title')
    ...
    <li class="breadcrumb-item"><a href="#"> Transport Orders </a></li>
@endsection
                        ...
                        @foreach($transportOrders as $order)
                            <tr>
                                ...
                                <td style='white-space: nowrap'>
                                    <a href="{{ route('transport-orders.show', $order->id) }}" class="btn btn-success btn-sm btn-rounded">
                                        Show
                                    </a>
                                    <a href="{{ route('transport-orders.edit', $order->id) }}" class="btn btn-primary btn-sm btn-rounded">
                                        Edit
                                    </a>
                                </td>
