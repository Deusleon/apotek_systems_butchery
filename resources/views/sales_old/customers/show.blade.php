                    ...
                    <form action="{{ route('customers.update','id') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="code" class="col-md-4 col-form-label text-md-right">Name</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control"
                                           id="phone_edit" name="phone" disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea type="text" class="form-control" id="address_edit" rows="1"
                                              ...
                                              placeholder="Enter Address" disabled="true"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="tin_edit" name="tin"
                                           placeholder="Enter TIN" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="code" class="col-md-4 col-form-label text-md-right">Credit Limit</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="credit_input_edit"
                                           placeholder="Enter Credit Limit" disabled>
                                </div>
                            </div>
