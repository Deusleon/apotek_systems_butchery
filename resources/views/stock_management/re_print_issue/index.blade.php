...
@section('content-sub-title')
    ...
    <li class="breadcrumb-item"><a href="#"> Inventory / Issue History </a></li>
@endsection
...
@section("content")
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="issued_date" class="form-control"
                                           id="d_auto_71" value="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="fixed-header-re-print" class="display table nowrap table-striped table-hover"
                                ...
                                @foreach($all_issues as $all_issue)
                                    <tr>
                                        ...
                                        <td>{{date('Y-m-d',strtotime($all_issue->created_at))}}</td>
                                        <td align="right">
                                            <div style="margin-right: 50%">
                                                {{number_format(floatval($all_issue->quantity))}}
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <button type="button" onclick="showIssue(this.value)"
                                                    ...
                                                    class='btn btn-sm btn-rounded btn-success'>Show
                                            </button>
                                            <button id='print' name="print" type="submit"
                                                    value="{{$all_issue->issue_no}}"
                                                    class='btn btn-sm btn-rounded btn-secondary'><span
    ...
    @include('stock_management.re_print_issue.show')
    ...
    <script type="text/javascript">
        var config = {
            routes: {
                ...
                stockIssueShowReprint: '{{route('stock-issue-show-reprint')}}'
