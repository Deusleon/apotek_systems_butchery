        ...
        <div class="modal-content">
            ...
            <form id="form_product_edit" action="{{route('products.update','id')}}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="barcode" class="col-md-4 col-form-label text-md-right">Barcode<font
                                color="red">*</font></label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        <label for="barcode" class="col-md-4 col-form-label text-md-right">Brand<font
                                color="red">*</font></label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        <label for="barcode" class="col-md-4 col-form-label text-md-right">Pack Size<font
                                color="red">*</font></label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" id="pack_size_edits" name="pack_size"
                                   placeholder="" value="{{ old('pack_size') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="saleUoM" class="col-md-4 col-form-label text-md-right">Unit of Measure<font
                                color="red">*</font></label>
                        <div class="col-md-8">
