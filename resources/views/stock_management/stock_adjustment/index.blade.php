        ...
        <ul class="nav nav-pills mb-3" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link text-uppercase" id="stock-adjustment-tablist" data-toggle="pill"
                    href="{{ url('inventory/stock-adjustment') }}" role="tab" aria-controls="stock_adjustment"
                    aria-selected="true">Stock Adjustment</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active text-uppercase" id="stock-list-tablist" data-toggle="pill" href="#stock-list"
                    role="tab" aria-controls="stock_list" aria-selected="false">Adjustment List
                </a>
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="stock-list" role="tabpanel" aria-labelledby="stock_list-tab">
                <div class="form-group row">
                    ...
                    <div class="col-md-3" style="margin-left: 2.5%">
                        <label style="margin-left: 80%" for="issued_date" class="col-form-label text-md-right">Date:</label>
                    </div>
                    <div class="col-md-3" style="margin-left: -3.1%">
                        <input style="width: 103.4%;" type="text" name="adjustment-date" onchange="getAdjustmentByDate()"
