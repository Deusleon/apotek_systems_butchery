...
@section("content")
    ...
    <div class="col-sm-12">
        <ul class="nav nav-pills mb-3" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active text-uppercase" id="stock-adjustment-tablist" data-toggle="pill"
                   href="#stock-adjustment" role="tab"
                   aria-controls="stock_adjustment" aria-selected="true">Stock Adjustment</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-uppercase" id="stock-list-tablist" data-toggle="pill"
                   href="{{ url('inventory/adjustment-history') }}" role="tab"
        ...
        <div class="tab-content" id="myTabContent">
            {{--  Tab for Stock Adjustment --}}
        <div class="tab-pane fade show active" id="stock-adjustment" role="tabpanel" aria-labelledby="stock_adjustment-tab">
        <div class="card">
            <div class="card-body">
                ...
                <div id="tbody_stock_status" style="display: none;" class="table-responsive">
                    ...
                    <button style="float: right; margin-right: 11.5%; margin-top: 2%"
...
@push("page_scripts")
    ...
    <script>
        ...
        function loadInStock() {
            ...
            $('#fixed-header1').DataTable({
                ...
                "columns": [
                    ...
                    {
                        "data": "action",
                        //<button id='pricing' class='btn btn-sm btn-rounded btn-primary' type='button'>Pricing</button>
                        defaultContent: "<div><button id='detail' class='btn btn-sm btn-rounded btn-success' type='button'>Details</button><button id='bulk_adjust' class='btn btn-sm btn-rounded btn-secondary' type='button'>Bulk Adjust</button></div>"
                    }
                    @endif
                ]
        ...
        $(document).ready(function () {
            ...
            $('#fixed-header-main').DataTable({
                ...
                "columns": [
                    ...
                    {
                        "data": "action",
                        //<button id='pricing_' class='btn btn-sm btn-rounded btn-primary' type='button'>Pricing</button>
                        defaultContent: "<div><button id='details' class='btn btn-sm btn-rounded btn-success' type='button'>Details</button><button id='bulk_adjust_' class='btn btn-sm btn-rounded btn-secondary' type='button'>Bulk Adjust</button></div>"
                    }
                    @endif
                ]
        ...
        var table_detail = $('#fixed-header-price').DataTable({
                ...
                'columns': [
                    ...
                    {
                        'data': 'action',
                        //<button id='edits' class='btn btn-sm btn-rounded btn-primary' type='button'>Edit</button>
                        defaultContent: "<div><button id='adjust' class='btn btn-sm btn-rounded btn-secondary' type='button'>Adjust</button></div>"
        ...
        $('#update_stock').on('submit', function () {
            ...
            if (Number(price) < Number(unit_cost)) {
                ...
                var r = confirm('Sell Price is less than Buy Price?');
                if (r === true) {
                    /*continue*/
                } else {
                    /*return false*/
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#stock-list-tablist').on('click', function(e) {
