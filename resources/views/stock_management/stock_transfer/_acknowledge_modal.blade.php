<div class="modal fade small-table" id="acknowledgeModal" tabindex="-1" role="dialog" aria-labelledby="acknowledgeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="transfer" action="{{ route('acknowledge-transfer') }}" method="post"
                    ...
                    <textarea name="remarks" id="acknowledge_remark" placeholder="Add your remarks here..." class="form-control" rows="3"></textarea>

                    <div class="text-right mt-3">
                        <button type="button" id="edit-acknowledge-btn" class="btn btn-sm btn-warning edit-acknowledge-btn text-body">Edit</button>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="confirmAcknowledgeBtn" class="btn btn-primary btn-sm">Yes, Acknowledge</button>
      </div>
    </div>
  </div>
</div>
