...
<div class="modal fade" id="editTransporter" tabindex="-1" role="dialog" aria-labelledby="editTransporterLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editTransporterLabel">Update Transporter</h5>
            ...
            <form method="POST" id="form_transporter_edit" action="">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="transport_type" id="transport_type_edit">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="number_of_vehicles" id="number_of_vehicles_edit" min="1" required>
