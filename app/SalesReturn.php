...
class SalesReturn extends Model
{
     ...
     public function item_returned(){
        return $this->hasOne(SalesDetail::class,'id','sale_detail_id')
                ...
                ->select('name','brand','pack_size','sales_uom','sales_details.quantity as bought_qty','sales_returns.quantity as rtn_qty','sales.date as b_date','sales_details.amount','sales_details.discount','sales_details.id as item_detail_id','sales_details.status as status','stock_id','sales.id as sale_id')
