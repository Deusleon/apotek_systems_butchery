    ...
    public function model( array $row )
 {
        ...
        try {
            ...
            $product = new Product([
                ...
                'pack_size' => $row['pack_size'] ?? null,
                'sales_uom' => $row['unit'] ?? null,
                'min_quantinty' => array_key_exists('min_stock', $row) && $row['min_stock'] !== null ? (int)$row['min_stock'] : null,
                'max_quantinty' => array_key_exists('max_stock', $row) && $row['max_stock'] !== null ? (int)$row['max_stock'] : null,
                // 'min_quantinty' => $row[ 'min_stock' ] !== null ? ( int )$row[ 'min_stock' ] : null,
                // 'max_quantinty' => $row[ 'max_stock' ] !== null ? ( int )$row[ 'max_stock' ] : null,
