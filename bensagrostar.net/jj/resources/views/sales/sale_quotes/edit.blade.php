...
@section('content-sub-title')
    ...
    <li class="breadcrumb-item"><a href="#">Sales / Update Sales Order</a></li>
@endsection
                ...
                <form id="quote_sale_form">
                    ...
                    <div class="row" id="detail">
                        ...
                        <div class="table-responsive" style="width: 100%;">
                            <table id="edit_sales_order" class="table nowrap table-striped table-hover" width="100%">
                                <thead>
                                <tr>
                                    <th>Product Name</th>
                                    <th>Quantity</th>
                                ...
                                @foreach($sales_details as $user)
                                    <tr>
                                        ...
                                        <td>{{number_format($user->discount,0) }} </td>
                                        <td> <a href="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group" style="float: right;">
                                <button id="sales_quotes" onclick="backToOrders()" class="btn btn-success">Back</button>
                                <button data-id="{{$quote_id}}"
                                        data-customer="{{$customer_id}}"
                                        class="btn btn-primary" id="convert_to_sales" data-target="convert_to_sales" >Convert</button>
                            </div>
                        </div>
                    </div>
