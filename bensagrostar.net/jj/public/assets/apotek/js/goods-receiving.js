...
$('#invoicecart_table tbody').on('click', '#edit_btn', function() {
    ...
    console.log('Hidden-Data', invoicecart_table);
    if (edit_btn_set === 0) {
...
function invoicevaluesCollection() {
    ...
    var selected_fields = product.split('#@');
    console.log("Read-data",selected_fields)
    var item_name = selected_fields[0]+selected_fields[0];
    var product_id = selected_fields[1];
    let selling_price = 0;
    let buying_price = 0;
